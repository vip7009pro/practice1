  ...
  switch (qr["command"]) {
    ...
    case "insert_pqc1":
      (async () => {
        ...
        let checkkq = "OK";
        let setpdQuery =
          "  INSERT INTO [dbo].[ZTBPQC1TABLE]([CTR_CD],[PROCESS_LOT_NO],[LINEQC_PIC],[PROD_PIC],[PROD_LEADER],[LINE_NO],[STEPS],[CAVITY],[SETTING_OK_TIME],[FACTORY],[REMARK],[INS_DATE],[UPD_DATE]) VALUES ('002','" +
          DATA.PROCESS_LOT_NO +
          "','" +
          DATA.LINEQC_PIC +
          "','" +
        ...
        if (checkkq != "OK") {
          res.send({
            tk_status: "NG",
            message: "Có lỗi khi nhập data lên hệ thống",
          });
        } else {
          res.send({ tk_status: "OK" });
        }
