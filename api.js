...
exports.process_api = function (req, res) {
    ...
    else if (qr['command'] == 'getAMAZON_DESIGN')
    {
        (async () => {
            let DATA = qr['DATA']; 
            //console.log(DATA);
    ...
    else if (qr['command'] == 'deleteAMZDesign')
    {
        (async () => {
            let DATA = qr['DATA']; 
            //console.log(DATA);
    ...
    else if (qr['command'] == 'checkDesignExistAMZ')
    {
        (async () => {
            let DATA = qr['DATA']; 
            //console.log(DATA);
    ...
    else if (qr['command'] == 'insertAMZDesign')
    {
        (async () => {
            let DATA = qr['DATA']; 
            //console.log(DATA);
...
ZTB_QLSXPLAN.PROD_REQUEST_NO, O302.PLAN_ID,ZTB_QLSXPLAN.PLAN_EQ, M100.G_CODE, M100.G_NAME, O302.FACTORY           
    ...
    else if (qr['command'] == 'insertFailingData')
    {
        (async () => {
            let DATA = qr['DATA']; 
            console.log(DATA);
    ...
    else if (qr['command'] == 'updateQCFailTableData')
    {
        (async () => {
            let DATA = qr['DATA']; 
            console.log(DATA);
    ...
    else if (qr['command'] == 'updateMaterialHoldingReason')
    {
        (async () => {
            let DATA = qr['DATA']; 
            console.log(DATA);
    ...
    else if (qr['command'] == 'checkPROCESS_LOT_NO')
    {
        (async () => {
            let DATA = qr['DATA']; 
            console.log(DATA);
