      ...
      case "capabydeliveryplan":
        (async () => {
          ...
          DECLARE @tradate date;
           ...
           (ZTBPLANTB.D1*1.0/M100.UPH1*60 + M100.Setting1) AS LT1,
           (ZTBPLANTB.D2*1.0/M100.UPH1*60 + M100.Setting1) AS LT2,
           (ZTBPLANTB.D3*1.0/M100.UPH1*60 + M100.Setting1) AS LT3,
           (ZTBPLANTB.D4*1.0/M100.UPH1*60 + M100.Setting1) AS LT4,
           (ZTBPLANTB.D5*1.0/M100.UPH1*60 + M100.Setting1) AS LT5,
           (ZTBPLANTB.D6*1.0/M100.UPH1*60 + M100.Setting1) AS LT6,
           (ZTBPLANTB.D7*1.0/M100.UPH1*60 + M100.Setting1) AS LT7,
           (ZTBPLANTB.D8*1.0/M100.UPH1*60 + M100.Setting1) AS LT8
           ...
           (ZTBPLANTB.D1*1.0/M100.UPH2*60 + M100.Setting2) AS LT1,
           (ZTBPLANTB.D2*1.0/M100.UPH2*60 + M100.Setting2) AS LT2,
           (ZTBPLANTB.D3*1.0/M100.UPH2*60 + M100.Setting2) AS LT3,
           (ZTBPLANTB.D4*1.0/M100.UPH2*60 + M100.Setting2) AS LT4,
           (ZTBPLANTB.D5*1.0/M100.UPH2*60 + M100.Setting2) AS LT5,
           (ZTBPLANTB.D6*1.0/M100.UPH2*60 + M100.Setting2) AS LT6,
           (ZTBPLANTB.D7*1.0/M100.UPH2*60 + M100.Setting2) AS LT7,
           (ZTBPLANTB.D8*1.0/M100.UPH2*60 + M100.Setting2) AS LT8
           FROM  ZTBPLANTB LEFT JOIN M100 ON (M100.G_CODE = ZTBPLANTB.G_CODE)
