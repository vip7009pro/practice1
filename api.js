    ...
    switch (qr["command"]) {
      ...
      case "get_listcustomer":
        (async () => {
          ...
          let startOfYear = moment().startOf("year").format("YYYY-MM-DD");
          let query = "";
          query = `SELECT CUST_CD, CUST_NAME_KD, CUST_NAME,  CUST_ADDR1, TAX_NO, CUST_NUMBER,  BOSS_NAME, TEL_NO1, FAX_NO, CUST_POSTAL, REMK, INS_DATE, INS_EMPL, UPD_DATE, UPD_EMPL FROM M110`;
          //console.log(query);
          kqua = await queryDB(query);
          ////console.log(kqua);
          res.send(kqua);
      ...
      case "add_customer":
        (async () => {
          ...
          let startOfYear = moment().startOf("year").format("YYYY-MM-DD");
          let query = "";
          query = `INSERT INTO M110 (CTR_CD, CUST_CD, CUST_NAME, CUST_NAME_KD, CUST_ADDR1, TAX_NO,CUST_NUMBER, BOSS_NAME, TEL_NO1, FAX_NO, CUST_POSTAL,REMK, INS_DATE, INS_EMPL, UPD_DATE, UPD_EMPL) VALUES ('002','${DATA.CUST_CD}', '${DATA.CUST_NAME}','${DATA.CUST_NAME_KD}','${DATA.CUST_ADDR1}','${DATA.TAX_NO}','${DATA.CUST_NUMBER}','${DATA.BOSS_NAME}','${DATA.TEL_NO1}','${DATA.FAX_NO}','${DATA.CUST_POSTAL}','${DATA.REMK}',GETDATE(), '${EMPL_NO}',GETDATE(), '${EMPL_NO}')`;
          console.log(query);
          kqua = await queryDB(query);
          //console.log(kqua);
          res.send(kqua);
      ...
      case "addMaterial":
        (async () => {
          ...
          let startOfYear = moment().startOf("year").format("YYYY-MM-DD");
          let query = "";
          query = `INSERT INTO ZTB_MATERIAL_TB (CTR_CD, M_NAME, DESCR, CUST_CD, SSPRICE, CMSPRICE, SLITTING_PRICE, MASTER_WIDTH, ROLL_LENGTH, INS_DATE, INS_EMPL, UPD_DATE, UPD_EMPL) VALUES ('002', '${DATA.M_NAME}',N'${DATA.DESCR}','${DATA.CUST_CD}','${DATA.SSPRICE}','${DATA.CMSPRICE}','${DATA.SLITTING_PRICE}','${DATA.MASTER_WIDTH}','${DATA.ROLL_LENGTH}',GETDATE(),'${EMPL_NO}',GETDATE(),'${EMPL_NO}')`;
          console.log(query);
          kqua = await queryDB(query);
          ////console.log(kqua);
          res.send(kqua);
      ...
      case "updateMaterial":
        (async () => {
          ...
          let startOfYear = moment().startOf("year").format("YYYY-MM-DD");
          let query = "";
          query = `UPDATE ZTB_MATERIAL_TB SET CUST_CD ='${DATA.CUST_CD}',DESCR =N'${DATA.DESCR}',SSPRICE ='${DATA.SSPRICE}',CMSPRICE ='${DATA.CMSPRICE}',SLITTING_PRICE ='${DATA.SLITTING_PRICE}', MASTER_WIDTH ='${DATA.MASTER_WIDTH}',ROLL_LENGTH ='${DATA.ROLL_LENGTH}',UPD_EMPL ='${EMPL_NO}', UPD_DATE=GETDATE() WHERE M_NAME='${DATA.M_NAME}' `;
          console.log(query);
          kqua = await queryDB(query);
          ////console.log(kqua);
          res.send(kqua);
 ...
 ORDER BY ZTBEMPLINFOA.DATE_COLUMN DESC, ZTBEMPLINFOA.POSITION_CODE ASC`;
      ...
      case "insertM100_AddVer":
        (async () => {
          ...
          let SUBDEPTNAME = req.payload_data["SUBDEPTNAME"];
          let checkkq = "OK";
          let setpdQuery = `INSERT INTO M100 (CTR_CD,CUST_CD,PROD_PROJECT,PROD_MODEL,CODE_12,PROD_TYPE,G_NAME_KD,DESCR,PROD_MAIN_MATERIAL,G_NAME,G_LENGTH,G_WIDTH,PD,G_C,G_C_R,G_SG_L,G_SG_R,PACK_DRT,KNIFE_TYPE,KNIFE_LIFECYCLE,KNIFE_PRICE,CODE_33,ROLE_EA_QTY,RPM,PIN_DISTANCE,PROCESS_TYPE,EQ1,EQ2,EQ3, EQ4,PROD_DIECUT_STEP,PROD_PRINT_TIMES,REMK,USE_YN,G_CODE,G_CG,G_LG, SEQ_NO, CODE_27, REV_NO, INS_EMPL, UPD_EMPL, INS_DATE, UPD_DATE, PO_TYPE, FSC) VALUES ('002','${DATA.CODE_FULL_INFO.CUST_CD}','${DATA.CODE_FULL_INFO.PROD_PROJECT}','${DATA.CODE_FULL_INFO.PROD_MODEL}','${DATA.CODE_FULL_INFO.CODE_12}','${DATA.CODE_FULL_INFO.PROD_TYPE}','${DATA.CODE_FULL_INFO.G_NAME_KD}','${DATA.CODE_FULL_INFO.DESCR}','${DATA.CODE_FULL_INFO.PROD_MAIN_MATERIAL}','${DATA.CODE_FULL_INFO.G_NAME}','${DATA.CODE_FULL_INFO.G_LENGTH}','${DATA.CODE_FULL_INFO.G_WIDTH}','${DATA.CODE_FULL_INFO.PD}','${DATA.CODE_FULL_INFO.G_C}','${DATA.CODE_FULL_INFO.G_C_R}','${DATA.CODE_FULL_INFO.G_SG_L}','${DATA.CODE_FULL_INFO.G_SG_R}','${DATA.CODE_FULL_INFO.PACK_DRT}','${DATA.CODE_FULL_INFO.KNIFE_TYPE}','${DATA.CODE_FULL_INFO.KNIFE_LIFECYCLE}','${DATA.CODE_FULL_INFO.KNIFE_PRICE}','${DATA.CODE_FULL_INFO.CODE_33}','${DATA.CODE_FULL_INFO.ROLE_EA_QTY}','${DATA.CODE_FULL_INFO.RPM}','${DATA.CODE_FULL_INFO.PIN_DISTANCE}','${DATA.CODE_FULL_INFO.PROCESS_TYPE}','${DATA.CODE_FULL_INFO.EQ1}','${DATA.CODE_FULL_INFO.EQ2}','${DATA.CODE_FULL_INFO.EQ3}','${DATA.CODE_FULL_INFO.EQ4}','${DATA.CODE_FULL_INFO.PROD_DIECUT_STEP}','${DATA.CODE_FULL_INFO.PROD_PRINT_TIMES}','${DATA.CODE_FULL_INFO.REMK}','${DATA.CODE_FULL_INFO.USE_YN}','${DATA.G_CODE}','${DATA.CODE_FULL_INFO.G_CG}','${DATA.CODE_FULL_INFO.G_LG}','${DATA.NEXT_SEQ_NO}','${DATA.CODE_27}','${DATA.REV_NO}','${EMPL_NO}','${EMPL_NO}',GETDATE(), GETDATE(), '${DATA.CODE_FULL_INFO.PO_TYPE}', '${DATA.CODE_FULL_INFO.FSC}')`;
          ////console.log(setpdQuery);
          checkkq = await queryDB(setpdQuery);
          res.send(checkkq);
          ////console.log(checkkq);
      ...
      case "getqlsxplan2":
        (async () => {
          ...
          let setpdQuery = `SELECT ZTB_QLSXPLAN.XUATDAOFILM, ZTB_QLSXPLAN.EQ_STATUS, ZTB_QLSXPLAN.MAIN_MATERIAL, ZTB_QLSXPLAN.INT_TEM, ZTB_QLSXPLAN.CHOTBC, ZTB_QLSXPLAN.DKXL,ZTB_QLSXPLAN.NEXT_PLAN_ID, ZTB_QLSXPLAN.KQ_SX_TAM, ZTB_QLSXPLAN.KETQUASX, ZTB_QLSXPLAN.PROCESS_NUMBER, ZTB_QLSXPLAN.PLAN_ORDER, ZTB_QLSXPLAN.STEP, ZTB_QLSXPLAN.PLAN_ID,ZTB_QLSXPLAN.PLAN_DATE,ZTB_QLSXPLAN.PROD_REQUEST_NO,ZTB_QLSXPLAN.PLAN_QTY,ZTB_QLSXPLAN.PLAN_EQ,ZTB_QLSXPLAN.PLAN_FACTORY,ZTB_QLSXPLAN.PLAN_LEADTIME,ZTB_QLSXPLAN.INS_EMPL,ZTB_QLSXPLAN.INS_DATE,ZTB_QLSXPLAN.UPD_EMPL,ZTB_QLSXPLAN.UPD_DATE, M100.G_CODE, M100.G_NAME, M100.G_NAME_KD, P400.PROD_REQUEST_DATE, P400.PROD_REQUEST_QTY, isnull(BB.CD1,0) AS CD1, isnull(BB.CD2,0) AS CD2, BB.CD3, BB.CD4,
...
ON(DIEMDANHBP.MAINDEPTNAME = BANGNGHI.MAINDEPTNAME)`;
      ...
      case "loadpono":
        (async () => {
          ...
          let SUBDEPTNAME = req.payload_data["SUBDEPTNAME"];
          let checkkq = "OK";
          let setpdQuery = `SELECT PO_NO, CUST_CD, G_CODE, PO_DATE FROM ZTBPOTable WHERE G_CODE='${DATA.G_CODE}' AND CUST_CD ='${DATA.CUST_CD}' ORDER BY PO_DATE DESC`;
          console.log(setpdQuery);
          checkkq = await queryDB(setpdQuery);
          //console.log(checkkq);
          res.send(checkkq);
      ...
      case "dongbogiasptupo":
        (async () => {
          ...
          SELECT '002' AS CTR_CD, AA.CUST_CD, AA.G_CODE, AA.PRICE_DATE, AA.MOQ, AA.PROD_PRICE, GETDATE() AS INS_DATE,'NHU1903' AS INS_EMPL, GETDATE() AS UPD_DATE,'NHU1903' AS UPD_EMPL, 'AUTO' AS REMARK, 'N' AS FINAL, 'USD' AS CURRENCY, null as RATE  FROM 
          (
      ...
      case "capabydeliveryplan":
        (async () => {
          ...
          DECLARE @tradate date;
           ...
           (ZTBPLANTB.D1*1.0/M100.UPH1*60*M100.Step1 + M100.Setting1) AS LT1,
           (ZTBPLANTB.D2*1.0/M100.UPH1*60*M100.Step1 + M100.Setting1) AS LT2,
           (ZTBPLANTB.D3*1.0/M100.UPH1*60*M100.Step1 + M100.Setting1) AS LT3,
           (ZTBPLANTB.D4*1.0/M100.UPH1*60*M100.Step1 + M100.Setting1) AS LT4,
           (ZTBPLANTB.D5*1.0/M100.UPH1*60*M100.Step1 + M100.Setting1) AS LT5,
           (ZTBPLANTB.D6*1.0/M100.UPH1*60*M100.Step1 + M100.Setting1) AS LT6,
           (ZTBPLANTB.D7*1.0/M100.UPH1*60*M100.Step1 + M100.Setting1) AS LT7,
           (ZTBPLANTB.D8*1.0/M100.UPH1*60*M100.Step1 + M100.Setting1) AS LT8
           ...
           UNPiVOT
           (
             LEATIME FOR LT IN ([LT1],[LT2],[LT3],[LT4],[LT5],[LT6],[LT7],[LT8])
           ) as upv
           UNION ALL
           ...
           (ZTBPLANTB.D1*1.0/M100.UPH2*60*M100.Step2 + M100.Setting2) AS LT1,
           (ZTBPLANTB.D2*1.0/M100.UPH2*60*M100.Step2 + M100.Setting2) AS LT2,
           (ZTBPLANTB.D3*1.0/M100.UPH2*60*M100.Step2 + M100.Setting2) AS LT3,
           (ZTBPLANTB.D4*1.0/M100.UPH2*60*M100.Step2 + M100.Setting2) AS LT4,
           (ZTBPLANTB.D5*1.0/M100.UPH2*60*M100.Step2 + M100.Setting2) AS LT5,
           (ZTBPLANTB.D6*1.0/M100.UPH2*60*M100.Step2 + M100.Setting2) AS LT6,
           (ZTBPLANTB.D7*1.0/M100.UPH2*60*M100.Step2 + M100.Setting2) AS LT7,
           (ZTBPLANTB.D8*1.0/M100.UPH2*60*M100.Step2 + M100.Setting2) AS LT8
           FROM  ZTBPLANTB LEFT JOIN M100 ON (M100.G_CODE = ZTBPLANTB.G_CODE)
