...
exports.SEMANTIC_ENGINE_CONFIG = {
    ...
    DEFAULT_TOP_K: parseInt(process.env.SEMANTIC_TOP_K || String(exports.DEFAULT_TOP_K), 10),
    // Semantic retrieval
    SIMILARITY_THRESHOLD: 0.5,
    FUZZY_MATCH_THRESHOLD: 0.6,
    // Pipeline
    ENABLE_CACHING: String(process.env.SEMANTIC_ENABLE_CACHING || 'true').toLowerCase() === 'true',
    CACHE_TTL_MS: parseInt(process.env.SEMANTIC_CACHE_TTL_MS || '3600000', 10),
    // Debug
    DEBUG: String(process.env.SEMANTIC_DEBUG || '').toLowerCase() === 'true',
};
exports.SQL_SAFETY_CONFIG = {
