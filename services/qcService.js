...
, 
IQC1_TABLE.INS_DATE, IQC1_TABLE.INS_EMPL, IQC1_TABLE.UPD_DATE, IQC1_TABLE.UPD_EMPL, IQC1_TABLE.REMARK, ZTB_MATERIAL_TB.M_THICKNESS FROM IQC1_TABLE 
LEFT JOIN 
...
exports.updateMThickness   = async (req, res, DATA) => {
  let checkkq = "OK";
  let setpdQuery = `
UPDATE ZTB_MATERIAL_TB SET M_THICKNESS=${DATA.M_THICKNESS} WHERE CTR_CD='${DATA.CTR_CD}' AND M_NAME='${DATA.M_NAME}'
  `;
  console.log(setpdQuery);
  checkkq = await queryDB(setpdQuery);
  //console.log(checkkq);
