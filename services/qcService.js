...
ZTBATTENDANCETB2 AS 
(
SELECT EMPL_NO, SUM(CASE WHEN WORK_HOUR > 0 THEN WORK_HOUR+1 ELSE 0 END) AS WORK_HOUR, SUM((CASE WHEN WORK_HOUR > 0 THEN WORK_HOUR+1 ELSE 0 END)*60) AS WORK_MINUTE FROM ZTBATTENDANCETB WHERE APPLY_DATE BETWEEN   '2026-03-01' AND '2026-03-31 23:59:59' GROUP BY EMPL_NO
),
INSP_TABLE2 AS
(
SELECT EMPL_NO, 
