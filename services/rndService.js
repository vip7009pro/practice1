...
exports.tilefilmbandaily = async (req, res, DATA) => {
  ...
  SELECT PLAN_DATE, SUM(QTY_KNIFE_FILM) AS FILM_QTY_TT, SUM(PROD_PRINT_TIMES) AS FILM_QTY_LT FROM OUT_FILM_BACKDATA 
...
SELECT PLAN_YEAR,PLAN_WEEK,PLAN_YW, SUM(QTY_KNIFE_FILM) AS FILM_QTY_TT, SUM(PROD_PRINT_TIMES) AS FILM_QTY_LT FROM OUT_FILM_BACKDATA 
WHERE PLAN_DATE BETWEEN '${DATA.FROM_DATE}' AND '${DATA.TO_DATE}'
...
SELECT PLAN_YEAR,PLAN_MONTH,PLAN_YM, SUM(QTY_KNIFE_FILM) AS FILM_QTY_TT, SUM(PROD_PRINT_TIMES) AS FILM_QTY_LT FROM OUT_FILM_BACKDATA 
WHERE PLAN_DATE BETWEEN '${DATA.FROM_DATE}' AND '${DATA.TO_DATE}'
...
SELECT PLAN_YEAR, SUM(QTY_KNIFE_FILM) AS FILM_QTY_TT, SUM(PROD_PRINT_TIMES) AS FILM_QTY_LT FROM OUT_FILM_BACKDATA 
WHERE PLAN_DATE BETWEEN '${DATA.FROM_DATE}' AND '${DATA.TO_DATE}'
