...
exports.processApi = async (req, res) => {
  ...
  if(command !== 'login' && command !=='login2')
  {
    ...
    console.log(moment().format('YYYY-MM-DD HH:mm:ss'),EMPL_NO, command);
  }
  else {
